            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div className="navbar-nav ms-auto">
                        <Link className="nav-link nav-ele" to="/about">
                            About Us
                        </Link>
              
                        <Link className="nav-link nav-ele" to="/feedback">
                            Feedback
                        </Link> 
                        {!isLoggedIn ? (
                            <>
                            ...
                            <>
                               {!hideLogout && ( <span className="nav-link nav-ele" style={{ cursor: 'pointer' }} onClick={handleLogout}>
                                    Logout
                                </span>)}
